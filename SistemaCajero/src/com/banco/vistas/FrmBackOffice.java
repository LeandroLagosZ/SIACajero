...
public class FrmBackOffice extends JFrame {
    ...
    public FrmBackOffice() {
        ...
        // Abre maximizado para que no se corten los datos
        ...
        panelSuperior.setBackground(new Color(0, 42, 141)); // Azul BCP
        ...
        btnRefrescar.setBackground(new Color(255, 114, 0)); // Naranja BCP
